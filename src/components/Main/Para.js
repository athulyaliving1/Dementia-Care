  ...
  return (
    <div>
      ...
      >
        ...
        high-quality, one-on-one care they need. We foster the development of a
        true community for our senior residents with dementia and their
        ...
        loved one is tailored by trained and committed team members to make sure
        they are doing what is familiar and comfortable for them.
      </div>
    </div>
  );
}
