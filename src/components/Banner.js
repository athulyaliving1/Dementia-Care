        ...
        <div className="container mx-auto   grid md:grid-cols-2">
          ...
          <div className="">
            <div className="container text-justify mt-5 mb-5 ">
              ...
              <div className="grid grid-flow-row  bg-zinc-50  rounded-2xl px-5 p-3 xl:block  font-Poppins">
                <div>
                  <Formik
                    initialValues={{
                      name: "",
                        ...
                        <div className="">
                          <div class="relative z-0 mb-6 w-full group">
                            <Field
                              ...
                              name="name"
                              id="floating_name"
                              class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-sky-900 appearance-none focus:outline-none focus:ring-0 focus:border-sky-800 peer"
                              placeholder=" "
                              required
                            />
